...
import (
	...
	"github.com/igrs/concourse-example-api/restapi/operations/pet"
	"github.com/igrs/concourse-example-api/restapi/operations/store"
	"github.com/igrs/concourse-example-api/restapi/operations/user"
)

//go:generate swagger generate server --target .. --name example --spec ../swagger.json
